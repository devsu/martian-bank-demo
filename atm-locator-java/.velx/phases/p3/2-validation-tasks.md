...
### [P3-003] - [AI] Create AtmCreateRequest DTO with Bean Validation
...
### [P3-004] - [AI] Add POST /atm/add endpoint to AtmController
...
### [P3-005] - [AI] Extend GlobalExceptionHandler for validation errors
...
### [P3-006] - [AI] Add field-level validation for nested objects
